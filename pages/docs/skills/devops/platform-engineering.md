...
description: Design and implement Internal Developer Platforms (IDPs) with self-service capabilities and golden paths
tags: [devops, platform-engineering, idp, backstage, developer-experience, golden-paths]
---
...
- [Implementing GitOps](./implementing-gitops) - GitOps principles, Argo CD / Flux implementation
- [Building CI Pipelines](./building-ci-pipelines) - CI/CD pipeline design integrated into platform
- [Testing Strategies](./testing-strategies) - Testing best practices enforced through golden paths

## References

- [Full Skill Documentation](https://github.com/ancoleman/ai-design-components/tree/main/skills/platform-engineering)
- [IDP Architecture Guide](https://github.com/ancoleman/ai-design-components/tree/main/skills/platform-engineering/references/idp-architecture.md)
- [Golden Paths Guide](https://github.com/ancoleman/ai-design-components/tree/main/skills/platform-engineering/references/golden-paths.md)
- [Tool Recommendations](https://github.com/ancoleman/ai-design-components/tree/main/skills/platform-engineering/references/tool-recommendations.md)
- [Implementation Examples](https://github.com/ancoleman/ai-design-components/tree/main/skills/platform-engineering/examples)
