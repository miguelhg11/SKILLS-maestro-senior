...
description: Guide incident response from detection to post-mortem using SRE principles and blameless culture
tags: [devops, incident-management, sre, on-call, post-mortems, blameless-culture]
---
...
- [Platform Engineering](./platform-engineering) - Platform reliability and self-service reducing incidents
- [Implementing GitOps](./implementing-gitops) - GitOps enables fast rollback during incidents
- [Testing Strategies](./testing-strategies) - Comprehensive testing prevents incidents

## References

- [Full Skill Documentation](https://github.com/ancoleman/ai-design-components/tree/main/skills/managing-incidents)
- [Severity Classification Guide](https://github.com/ancoleman/ai-design-components/tree/main/skills/managing-incidents/references/severity-classification.md)
- [Blameless Post-Mortems](https://github.com/ancoleman/ai-design-components/tree/main/skills/managing-incidents/references/blameless-postmortems.md)
- [Runbook Templates](https://github.com/ancoleman/ai-design-components/tree/main/skills/managing-incidents/examples/runbooks)
- [Post-Mortem Template](https://github.com/ancoleman/ai-design-components/tree/main/skills/managing-incidents/examples/postmortem-template.md)
